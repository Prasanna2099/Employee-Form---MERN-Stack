...
function Home() {
  ...
  const fetchEmployees = () => {
    axios
      .get(
        "http://mernemployeeregistrationform-production.up.railway.app/employees"
      )
      .then((res) => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(
        "http://mernemployeeregistrationform-production.up.railway.app/create",
  ...
  const updateName = (id) => {
    axios
      .put(
        "http://mernemployeeregistrationform-production.up.railway.app/employees/name",
        { name: newname, id: id }
      )
      .then(() => {
  ...
  const updateAge = (id) => {
    axios
      .put(
        "http://mernemployeeregistrationform-production.up.railway.app/employees/age",
        { age: newAge, id: id }
      )
      .then(() => {
        console.log("Employee was updated");
  ...
  const updateDepartment = (id) => {
    axios
      .put(
        "http://mernemployeeregistrationform-production.up.railway.app/employees/department",
  ...
  const updateDesignation = (id) => {
    axios
      .put(
        "http://mernemployeeregistrationform-production.up.railway.app/employees/designation",
  ...
  const updateSalary = (id) => {
    axios
      .put(
        "http://mernemployeeregistrationform-production.up.railway.app/employees/salary",
  ...
  const updateAddress = (id) => {
    axios
      .put(
        "http://mernemployeeregistrationform-production.up.railway.app/employees/address",
  ...
  const handleDelete = (id) => {
    axios
      .delete(
        `http://mernemployeeregistrationform-production.up.railway.app/employees/${id}`
      )
      .then(() => {
    ...
    <div className="w-full h-[1200px]">
      ...
      <div className="flex justify-center items-center">
        <form onSubmit={handleSubmit}>
          ...
          <br />
          <input
            className="w-[400px] h-[50px] bg-zinc-600 p-2 text-white rounded-lg border-white border"
            type="text"
            placeholder="Name"
            value={name}
          ...
          <br />
          <button
            className="w-[400px] h-[50px] text-white border bg-[#1a1a1a] hover:bg-zinc-800"
            type="submit"
          >
            Sumbit Form
          </button>
          ...
          {employees.map((employee) => (
            <div key={employee.id}>
              <ul className="p-4">
                <li>
                  <button
                    className="translate-x-[-20px] font-bold hover:text-zinc-700 border p-1"
                  ...
                  Name: {employee.name}
                  <input
                    className="m-3 bg-zinc-600 p-1"
                    type="text"
                    placeholder="Update Name"
                    onChange={(e) => setNewName(e.target.value)}
                  />
                  <button
                    className="border p-1 hover:bg-teal-900/80"
                    onClick={() => updateName(employee.id)}
                  >
                    Update
                  </button>
                </li>
                ...
                <li>
                  ...
                  <button
                    className="border p-1 hover:bg-teal-900/80"
                    onClick={() => updateDepartment(employee.id)}
                  >
                    Update
                  </button>
                </li>
                ...
                <li>
                  ...
                  <button
                    className="border p-1 hover:bg-teal-900/80"
                    onClick={() => updateDesignation(employee.id)}
                  >
                    Update
                  </button>
                </li>
                ...
                <li>
                  ...
                  <button
                    className="border p-1 hover:bg-teal-900/80"
                    onClick={() => updateAddress(employee.id)}
                  >
                    Update
                  </button>
                </li>
